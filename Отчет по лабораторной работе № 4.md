...
<p align=center><img src=./img/maket_homepage.png></p>
...
<p align=center><img src=./img/homepage.png></p>

<p align=center>Рисунок 4 - Верстка homepage</p>

<p align=center><img src=./img/blogpage.png></p>
...
Вывод: в ходе работы были закреплены навыки cтилизации и трансформации элементов через CSS. Приобретены знания и навыки по работе с tailwind. Также была изучена теоритическая информация про ООЯП - JavaScript, которая в ходе работы была закреплена на практике. 
